...
var emailInputValidation = modalQuestion.querySelector('.modal__validation--email');
var nameInputValidation = modalQuestion.querySelector('.modal__validation--name');
var questionInputValidation = modalQuestion.querySelector('.modal__validation--question');
